...
export function DateFilter(props: DateFilterProps) {
  ...
  if (props.mode === 'range') {
    ...
    const setYesterday = () =>
      props.onChange(yesterdayValue, yesterdayValue)
      ...
      <div className={cn('space-y-2', props.className)}>
        ...
        >
          <Shortcut
            label="Today"
            active={
              props.startDate === todayValue &&
              props.endDate === todayValue
            }
            onClick={setToday}
          />
          ...
          <Shortcut
            label="Yesterday"
            active={
              props.startDate === yesterdayValue &&
              props.endDate === yesterdayValue
            }
          ...
          <Shortcut
            label="This month"
            active={
              props.startDate === monthStart &&
              props.endDate === monthEnd
            }
            onClick={() =>
              props.onChange(monthStart, monthEnd)
            }
          />
    ...
    return (
      <div className={cn('space-y-2', props.className)}>
        ...
        >
          <Shortcut
            label="Today"
            active={props.value === currentMonth}
            onClick={() =>
          ...
          <Shortcut
            label="Yesterday"
            active={props.value === yesterdayMonth}
            onClick={() =>
              props.onChange(yesterdayMonth)
            }
          />
